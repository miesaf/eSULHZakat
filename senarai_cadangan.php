...
?>
    ...
    <title>[E-Asnaf Transfer] - Senarai Cadangan Asnaf</title>
...
<body>
    <div id="wrapper">
        ...
        <!-- mula     ##########################################################################################     mula -->
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Senarai Cadangan Asnaf</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-8">
					<form role="form" id="senarai_permohonan" action ="senarai_cadangan.php" method ="get" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        if(isset($_GET['PAPAR']) && $_GET['PAPAR'] == "YES")
                        {
                            ...
                            $sql = "SELECT * FROM CADANG_ASNAF WHERE NEGERI = \"$NEGERI\" AND DAERAH = \"$DAERAH\" AND PERUMAHAN = \"$PERUMAHAN\" ORDER BY JENIS, NAMA";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center><b>Senarai Cadangan Asnaf Mengikut Kawasan Perumahan</b></center>
                        </div>
                        <!-- /.panel-heading -->
                        ...
                        <?php                            
                            ...
                            {            
                                ...
                                while ($row = mysql_fetch_array($result))
                                {
                                    ...
                                    echo "<td>$NAMA</td>\n\t\t\t\t\t\t\t<td align=center>$DJENIS</td>\n\t\t\t\t\t\t\t<td align=center><a target='_blank' href='rincian_cadangan.php?ID=$NO_KP'><button class='btn btn-outline btn-info'>Butiran</button></a></td>\n\t\t\t\t\t\t\t";
                                    echo "</tr>\n\t\t\t\t\t\t"; 
                                }
                            }
                        ?>
