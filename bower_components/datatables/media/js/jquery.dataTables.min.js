...
JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": aktifkan untuk susun lajur secara menaik",sSortDescending:": aktifkan untuk susun lajur secara menurun"},oPaginate:{sFirst:"Pertama",sLast:"Terakhir",sNext:"Seterusnya",sPrevious:"Sebelumnya"},sEmptyTable:"Tiada data untuk dipaparkan",sInfo:"Memaparkan _START_ - _END_ daripada _TOTAL_ rekod",sInfoEmpty:"Memaparkan 0 - 0 daripada 0 rekod",sInfoFiltered:"(ditapis dari _MAX_ jumlah rekod)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Papar _MENU_ rekod",sLoadingRecords:"Sedang dimuatkan...",sProcessing:"Sedang diproses...",sSearch:"Cari:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Tiada data sepadan ditemui"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(m.defaults);m.defaults.column={aDataSort:null,iDataSort:-1,
