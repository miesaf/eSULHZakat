...
<body>
    <div id="wrapper">
        ...
        <!-- mula     ##########################################################################################     mula -->
            ...
            <div class="row">
                <div class="col-lg-8">
					<form role="form" id="senarai_permohonan" action ="senarai_permohonan_daerah.php" method ="get" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        if(isset($_GET['PAPAR']) && $_GET['PAPAR'] == "YES")
                        {
                            ...
                            $sql = "SELECT * FROM PERMOHONAN WHERE NEGERI = \"$NEGERI\" AND DAERAH = \"$DAERAH\" ORDER BY JENIS, NAMA";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <center><b>Senarai Permohonan Zakat Mengikut Daerah</b></center>
                        </div>
                        <!-- /.panel-heading -->
